...
let scanTimer = null;
let lastScan = { ok:true, strategy:'VOLUME', observerOnly:true, implemented:false, status:'WAITING', reason:'아직 US-VOLUME 후보 스캔을 실행하지 않았습니다.', updatedAt:null, market:null, candidates:[], errors:[] };
